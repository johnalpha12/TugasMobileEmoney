...
import 'inbox.dart'; // Import the inbox.dart file
...
class _HomeState extends State<Home> {
  ...
  final List<Widget> _pages = [
    ...
    const History(), // Using History from history.dart
    ScanQr(),
    Pocket(),
    const ProfilePage(),
  ];
          ...
          children: [
            Row(
              ...
              children: [
                ...
                // Added GestureDetector to navigate to Inbox when tapped
                GestureDetector(
                  onTap: () {
                    Navigator.push(
                      context,
...
// Pocket class remains unchanged
